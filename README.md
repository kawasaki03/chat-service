...
## 利用方法
まずは先生が会員登録をした後、設定した「講師ID(任意の文字列)」を生徒様に伝え、生徒会員登録をしていただくことで、先生と生徒様間でのチャット形式による連絡のやり取りが可能になります。複数人の生徒様に会員登録をしていただくと、その生徒様同士でのチャットも可能です。

## 目指した課題解決
ユーザーは、個人経営の教室を開かれている先生と、その教室に通われている生徒様を想定いたしました。
目指した課題解決は2点ございます。
